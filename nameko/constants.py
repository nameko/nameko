...
CONCURRENCY_BACKEND_CONFIG_KEY = 'CONCURRENCY_BACKEND'
DEFAULT_CONCURRENCY_BACKEND = 'eventlet'

MONKEY_PATCH_ENFORCED_CONFIG_KEY = 'MONKEY_PATCH_ENFORCED'
DEFAULT_MONKEY_PATCH_ENFORCED = True
